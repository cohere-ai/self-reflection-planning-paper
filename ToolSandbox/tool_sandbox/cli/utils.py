...
from tool_sandbox.roles.anthropic_api_agent_sea import (
    ClaudeHaikuAgentSEA,
    ClaudeOpusAgentSEA,
    ClaudeSonnetAgentSEA,
    ClaudeSonnet35AgentSEA
)
from tool_sandbox.roles.base_role import BaseRole
from tool_sandbox.roles.cli_role import CliAgent, CliUser
from tool_sandbox.roles.cohere_agent import CohereAgent
from tool_sandbox.roles.cohere_agent_sea import CohereAgentSEA
...
from tool_sandbox.roles.mistral_api_agent import MistralAPIAgent
from tool_sandbox.roles.mistral_api_agent_sea import MistralAPIAgentSea
...
from tool_sandbox.roles.openai_api_agent_sea import (
    GPT_3_5_0125_Agent_SEA,
    GPT_4_0125_Agent_SEA,
    GPT_4_o_2024_05_13_Agent_SEA,
)
...
class RoleImplType(StrEnum):
    ...
    GPT_4_o_2024_05_13_SEA = auto()
    Claude_3_Opus = auto()
    Claude_3_Sonnet = auto()
    Claude_35_Sonnet = auto()
    Claude_3_Haiku = auto()
    Claude_35_Sonnet_SEA = auto()
    Gemini_1_0 = auto()
    Gemini_1_5 = auto()
    ...
    Cohere_Command_R_Plus_SEA = auto()
    Unhelpful = auto()
    MistralLarge = auto()
    MistralLargeSEA = auto()
...
AGENT_TYPE_TO_FACTORY: dict[RoleImplType, Callable[..., BaseRole]] = {
    ...
    # ),
    RoleImplType.MistralLarge: lambda: MistralAPIAgent(model_name="mistral-large-2407"),
    RoleImplType.MistralLargeSEA: lambda: MistralAPIAgentSea(model_name="mistral-large-2407"),
    ...
    RoleImplType.GPT_4_o_2024_05_13_SEA: GPT_4_o_2024_05_13_Agent_SEA,
    RoleImplType.Claude_3_Opus: ClaudeOpusAgent,
    RoleImplType.Claude_3_Sonnet: ClaudeSonnetAgent,
    RoleImplType.Claude_35_Sonnet: ClaudeSonnet35Agent,
    RoleImplType.Claude_3_Haiku: ClaudeHaikuAgent,
    RoleImplType.Claude_35_Sonnet_SEA: ClaudeSonnet35AgentSEA,
    ...
    RoleImplType.Cohere_Command_R_Plus: lambda: CohereAgent(
        ...
        RoleImplType.Cohere_Command_R_Plus_SEA: lambda: CohereAgentSEA(
        model_name="command-r-plus-08-2024"
    ),
...
def resolve_scenarios(
    ...
    print("Desired scenarios: ", len(desired_scenario_names))
    print("Resolved scenarios: ", len(name_to_scenario))
